...
export default function Meta() {
    return (
        <Head>
           /* Primary Meta Tags */
            <title>Ankit Verma Portfolio - Computer Engineering Student</title>
            <meta charSet="utf-8" />
            <meta name="title" content="Ankit Patel Portfolio - Computer Engineering Student" />
            <meta name="description"
                content="Ankit Verma (Ankit Verma) Personal Portfolio Website. Made with Ubuntu 20.4 (Linux) theme by Next.js and Tailwind CSS." />
